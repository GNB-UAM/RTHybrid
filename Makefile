...
# Project:  rthybrid_xen.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile rthybrid_xen.pro
#############################################################################
...
Makefile: rthybrid_xen.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile rthybrid_xen.pro
...
dist: 
	@test -d .tmp/RTHybrid1.0.0 || mkdir -p .tmp/RTHybrid1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/RTHybrid1.0.0/ && $(COPY_FILE) --parents clamp/includes/calibrate_functions_phase1.h clamp/includes/calibrate_functions_phase2.h clamp/includes/calibrate_functions_phase2_a.h clamp/includes/device_functions.h clamp/includes/model_library.h clamp/includes/queue_functions.h clamp/includes/rt_thread_functions.h clamp/includes/time_functions.h common/includes/types.h clamp/includes/writer_thread_functions.h clamp/includes/clamp.h clamp/includes/types_clamp.h gui/rthybrid.h .tmp/RTHybrid1.0.0/ && $(COPY_FILE) --parents gui/main.cpp clamp/src/model_library.c clamp/src/rt_thread_functions.c clamp/src/writer_thread_functions.c clamp/src/analogy_functions.c clamp/src/calibrate_functions_phase2_a.c clamp/src/calibrate_functions_phase1.c clamp/src/calibrate_functions_phase2.c clamp/src/time_functions.c clamp/src/queue_functions.c clamp/src/clamp.c common/src/aux_functions.c gui/rthybrid.cpp .tmp/RTHybrid1.0.0/ && $(COPY_FILE) --parents gui/rthybrid.ui .tmp/RTHybrid1.0.0/ && (cd `dirname .tmp/RTHybrid1.0.0` && $(TAR) RTHybrid1.0.0.tar RTHybrid1.0.0 && $(COMPRESS) RTHybrid1.0.0.tar) && $(MOVE) `dirname .tmp/RTHybrid1.0.0`/RTHybrid1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/RTHybrid1.0.0
...
moc_rthybrid.cpp: /usr/include/qt5/QtWidgets/QMainWindow \
