...
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -lrt -lm -lanalogy $(shell /usr/xenomai/bin/xeno-config --skin=posix --ldflags) -lQt5Multimedia -lQt5Widgets -L/usr/X11R6/lib64 -lQt5Gui -lQt5Network -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
distdir: FORCE
	...
	$(COPY_FILE) --parents clamp/src/analogy_functions.c gui/main.cpp clamp/src/model_library.c clamp/src/rt_thread_functions.c clamp/src/writer_thread_functions.c clamp/src/calibrate_functions_phase2_a.c clamp/src/calibrate_functions_phase1.c clamp/src/calibrate_functions_phase2.c clamp/src/time_functions.c clamp/src/queue_functions.c clamp/src/clamp.c common/src/aux_functions.c gui/rthybrid.cpp $(DISTDIR)/
