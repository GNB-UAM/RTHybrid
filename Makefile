...
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++ CONFIG+=release CONFIG+=qml_release CONFIG+=isol_core CORE=0 -o Makefile rthybrid.pro
#############################################################################
...
CFLAGS        = -pipe -D_GNU_SOURCE -I/usr/include/libxml2 -D__CORE__=0 -O2 -Wall -W -D_REENTRANT -fPIC $(DEFINES)
...
Makefile: rthybrid.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-g++ CONFIG+=release CONFIG+=qml_release CONFIG+=isol_core CORE=0 -o Makefile rthybrid.pro
