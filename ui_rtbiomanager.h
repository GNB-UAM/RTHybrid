...
public:
    ...
    void setupUi(QMainWindow *RTBiomanager)
    {
        ...
        frameSynapse->setGeometry(QRect(230, 180, 761, 271));
        ...
        label_43->setGeometry(QRect(20, 490, 171, 31));
        ...
        doubleSecPerBurst->setGeometry(QRect(1100, 415, 68, 24));
