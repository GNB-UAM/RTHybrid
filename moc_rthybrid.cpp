...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_RTHybrid_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 66, 30),
QT_MOC_LITERAL(6, 97, 25),
QT_MOC_LITERAL(7, 123, 21)
    },
...
const QMetaObject RTHybrid::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_RTHybrid.data,
      qt_meta_data_RTHybrid,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RTHybrid.stringdata))
