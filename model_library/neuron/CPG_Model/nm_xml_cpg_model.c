#include "nm_xml_cpg_model.h"

/**
 * @file nm_xml_cpg_model.c
 * @brief Source file with the CPG_Model neuron model functions.
 */

/**
 * @brief Imports the parameters of the CPG_Model neuron model from an XML file.
