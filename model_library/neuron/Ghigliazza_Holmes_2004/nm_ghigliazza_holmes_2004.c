...
void nm_ghigliazza_holmes_2004_select_dt (double pts_live, double * dt, double * pts_burst) {
...
void nm_ghigliazza_holmes_2004_set_pts_burst (double pts_live, neuron_model * nm) {
    if (nm->pts_burst == -1.0) {
        nm_ghigliazza_holmes_2004_select_dt(pts_live, &(nm->params[GH_DT]), &(nm->pts_burst));
    }
